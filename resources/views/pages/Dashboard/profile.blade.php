                                ...
                                <form action="{{ route('member.profile.update', [Auth::user()->id]) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="">
                                        <div class="px-4 py-5 sm:p-6">
                                            <div class="grid grid-cols-6 gap-6">
                                                <div class="col-span-6">
                                                    <div class="flex items-center mt-1">
                                                        ...
                                                        <label for="choose"
                                                                ...
                                                                focus:ring-2 focus:ring-offset-2 focus:ring-green-500">Choose File</label>

                                                        <input type="file" accept="image/*" id="choose" name="photo" hidden>

                                                        <a href="{{ route('member.delete.profile.picture') }}"
                                                            type="button"
                                                ...
                                                <div class="md:col-span-6 lg:col-span-3">
                                                    ...
                                                    <input placeholder="Your Name" type="text" name="name" id="name" value={{ $model_user->name ?? '' }} autocomplete="name" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>
                                                ...
                                                <div class="md:col-span-6 lg:col-span-3">
                                                    ...
                                                    <input placeholder="Role" type="text" name="role" id="role" autocomplete="role" value={{ $model_user->detail_user->role ?? '' }} class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>
                                                ...
                                                <div class="md:col-span-6 lg:col-span-3">
                                                    ...
                                                    <input placeholder="Your Email" type="text" name="email" id="email" autocomplete="email" value={{ $model_user->email ?? '' }} class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>
                                                ...
                                                <div class="md:col-span-6 lg:col-span-3">
                                                    ...
                                                    <input placeholder="087721205555" type="number" name="contact_number" id="contact_number" value={{ $model_user->detail_user->contact_number ?? '' }} autocomplete="contact_number" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>
                                                ...
                                                <div class="col-span-6">
                                                    ...
                                                    <textarea placeholder="Enter your biography here.." type="text" name="biography" id="biography" autocomplete="biography" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" rows="4">{{ $model_user->detail_user->biography }}
                                                    </textarea>
                                                ...
                                                <div class="col-span-6">
                                                    ...
                                                    @forelse ($experience_user as $key => $item )
                                                        <input placeholder="More than 9 years of experience" type="text" value={{ $item->experience }} name="{{ 'experience['. $item->id .']' }}" id="{{ 'experience['. $item->id .']' }}" autocomplete="{{ 'experience['. $item->id .']' }}" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                        ...
                                        <div class="px-4 py-3 text-right sm:px-6">
                                            ...
                                            <button type="submit" class="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-green-600 border border-transparent rounded-lg shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500" onclick="return confirm('Are you sure want to cancel?')">
                                                Save Changes
                                            </button>
                                        </div>
                                    </div>
